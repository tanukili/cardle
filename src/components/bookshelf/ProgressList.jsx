export default function ProgressList({ learningResources }) {
  ...
  const countProgress = (completedUnit, totalUnit) => (completedUnit / totalUnit) * 100;

  return (
    <ul className="list-unstyled mb-0 d-flex flex-column gap-6">
      {learningResources.map(({ id, type, title, completedUnit, totalUnit }) => (
        <li key={id}>
          <div className="progress-card card rounded-4 bg-gray-0 border-gray-200">
            <div className="card-body p-lg-6">
              <h3 className="fs-m fw-normal d-flex align-items-center mb-4 fs-xl-xl mb-lg-0 overflow-hidden">
                <span className="material-symbols-outlined text-gray-600 me-3">{typeIconMap[type]}</span>
                <span className="lh-base text-dark text-truncate">{title}</span>
              </h3>
              <div className="d-flex align-items-center">
                ...
                <button className="btn btn-outline-primary d-flex align-items-center p-2 ms-4 d-lg-none" type="button">
              ...
              <button
                ...
                type="button"
              >
                <span className="material-symbols-outlined d-xl-none">edit_square</span>
