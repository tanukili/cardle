...
export default function Features() {
  return (
    <>
      ...
      <section className="features-hero bg-white pt-30 pt-md-40">
        <div className="container">
          ...
          <div className="card shadow">
            <div className="card-header bg-white p-2 p-md-4">
      ...
      {/* intro-detail */}
      <section className="intro-detail bg-gray-600 py-10 py-lg-30">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 gx-10">
              <img
                src="features/product-2.png"
                className="intro-image container-fluid d-none d-lg-block"
                data-aos="fade-right"
                data-aos-duration="500"
                alt="product-2"
              />
            ...
            <div className="col-12 col-lg-6 gx-10 text-center text-lg-start">
              ...
              <img
                ...
                className="container-fluid d-lg-none"
                alt="product-2"
              />
              <h4 className="fs-l fs-md-xl fw-bold text-gray-0 mt-6 d-lg-none">
                Cardle 幫你把碎片化資訊，變成能長期成長的個人知識庫。
              </h4>
              <p className="fs-m fs-md-l text-gray-50 py-6 py-md-8">
                從今天開始，用卡片累積知識、整理思路。把想法寫成卡片，把知識連成脈絡。你可以透過標籤將卡片依做個人化的別類，將分散的學習內容將化為有結構的知識庫。
              </p>
              <h4 className="fs-l fs-md-xl fw-bold text-gray-0 mb-6 mb-md-8 d-none d-lg-block">
                Cardle 幫你把碎片化資訊，變成能長期成長的個人知識庫。
              </h4>
            </div>
          </div>
          ...
          <div className="row pt-10 pt-lg-30">
            <div className="col-12 col-lg-6 gx-10 text-center text-lg-start">
              ...
              />
              <h4 className="fs-l fs-md-xl fw-bold text-gray-0 mt-6 d-lg-none">
                Cardle 讓學習進度一目了然、不再遺忘。
              </h4>

              <p className="fs-m fs-md-l text-gray-50 py-6 py-md-8">
                集中整理你正在閱讀的文章、書籍、課程或影片，針對每項資源標記章節、頁碼或時間軸進度。系統會圖表化顯示學習進度，並自動提醒尚未完成的項目。
              </p>
              <h4 className="fs-l fs-md-xl fw-bold text-gray-0 mb-6 mb-md-8 d-none d-lg-block">
                Cardle 讓學習進度一目了然、不再遺忘。
              </h4>
      ...
      {/* users */}
      <section className="users overflow-x-hidden">
