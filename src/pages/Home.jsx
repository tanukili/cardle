      ...
      <section className="hero vh-100">
        <div className="container h-100">
          <div className="d-flex flex-column justify-content-center px-7_5 px-md-0 h-100">
            ...
            <p className="fw-bold fs-l fs-md-3xl mb-8" data-aos="fade-up" data-aos-delay="100">
      ...
      <main className="position-relative overflow-x-hidden">
        ...
        <section className="zettelkasten bg-light py-20 py-md-25">
          <div className="container">
            <div className="bg-gray-0 p-6 p-md-15 border border-gray-400 rounded-5 shadow" data-aos="fade-up">
              {/* 什麼是「 卡片筆記 」- 文字 */}
              <h2 className="fs-2xl fs-md-5xl pb-6 border-bottom border-gray-400 mb-6">什麼是「卡片筆記」？</h2>
              <p className="fw-bold fw-md-medium fs-md-2xl text-gray-600 mb-6 mb-md-10">
                卡片筆記是一種將知識分解、重組、連結的筆記方式，啟發自 Zettelkasten ( 德語：卡片盒筆記法 )
                與傳統段落式筆記不同，卡片筆記更接近人腦思考方式。
              </p>
              {/* 什麼是「 卡片筆記 」- 卡片列表 */}
              <ol className="d-flex flex-column flex-lg-row gap-6 list-unstyled mb-0">
                <li className="card border-gray-200 rounded-4 overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                  <img src="index/zettelkasten_01.png" className="card-img-top" alt="zettelkasten_01" />
                  <div className="card-body fs-md-xl p-md-6">
                    <p className="fw-bold text-gray-700 d-flex">
                      <span className="material-symbols-outlined align-bottom me-4 me-xl-6">check</span>
                      每張卡片紀錄一個單一概念
                    </p>
                  </div>
                </li>
                <li className="card border-gray-200 rounded-4 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                  <img src="index/zettelkasten_02.png" className="card-img-top" alt="zettelkasten_02" />
                  <div className="card-body fs-md-xl p-md-6">
                    <p className="fw-bold text-gray-700 d-flex">
                      <span className="material-symbols-outlined align-bottom me-4 me-xl-6">check</span>
                      透過標籤、分類與連結
                ...
                <li className="card border-gray-200 rounded-4 overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                  <img src="index/zettelkasten_03.png" className="card-img-top" alt="zettelkasten_03" />
                  <div className="card-body fs-md-xl p-md-6">
                    <p className="fw-bold text-gray-700 d-flex">
                      <span className="material-symbols-outlined align-bottom me-4 me-xl-6">check</span>
                      逐步建立出屬於你的知識地圖
          ...
          <div className="function-content">
            <div className="container">
              ...
              <div className="text-center mb-10 mb-md-16">
                <h2 className="fs-2xl fs-md-5xl mb-4 mb-md-6">Cardle 能為你做到什麼？</h2>
              ...
              >
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="d-md-flex justify-content-between gap-10 px-lg-10">
                    ...
                    <div className="d-flex flex-column justify-content-center max-w-516">
                      <h3 className="lh-base lh-md-sm text-primary-900 fs-xl fs-lg-3xl mb-4 mb-md-8">閱讀追蹤</h3>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="d-md-flex justify-content-between gap-10 px-lg-10">
                    ...
                    <div className="d-flex flex-column justify-content-center max-w-516 order-0">
                      <h3 className="lh-base lh-md-sm text-primary-900 fs-xl fs-lg-3xl mb-4 mb-md-8">卡片筆記</h3>
                      <p className="text-primary-900 fs-lg-l">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="d-md-flex justify-content-between gap-10 px-lg-10">
                    ...
                    <div className="d-flex flex-column justify-content-center max-w-516">
                      <h3 className="lh-base lh-md-sm text-primary-900 fs-xl fs-lg-3xl mb-4 mb-md-8">卡片盒管理</h3>
                      <p className="text-primary-900 fs-lg-l">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="d-md-flex justify-content-between gap-10 px-lg-10">
                    ...
                    <div className="d-flex flex-column justify-content-center max-w-516 order-0">
                      <h3 className="lh-base lh-md-sm text-primary-900 fs-xl fs-lg-3xl mb-4 mb-md-8">白板地圖</h3>
                      <p className="text-primary-900 fs-lg-l">
        ...
        <section className="reason bg-light py-20 py-md-25">
          <div className="container">
            ...
            <div className="reason-content text-center mb-10 mb-md-20">
              <h2 className="fs-2xl fs-md-5xl mb-4 mb-md-6">為什麼選擇 Cardle？</h2>
            ...
            <div className="d-flex flex-column flex-md-row gap-10 gap-lg-20">
              ...
              <div data-aos="fade-left">
                ...
                <div>
                  <h3 className="text-center text-primary-900 fs-xl fs-md-3xl mb-4">傳統筆記工具</h3>
                  <p className="text-center text-primary-800 fs-md-xl">難整理、難連結</p>
                </div>
              </div>
              {/* Cardle */}
              <div data-aos="fade-left" data-aos-delay="100">
                ...
                <div>
                  <h3 className="text-center text-primary-900 fs-xl fs-md-3xl mb-4">Cardle</h3>
                  <p className="text-center text-primary-800 fs-md-xl">自由連結與視覺化的知識地圖</p>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow mb-6">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      <div className="d-flex">
                        <span className="material-symbols-outlined fill text-star">star</span>
                        <span className="material-symbols-outlined fill text-star">star</span>
                        <span className="material-symbols-outlined fill text-star">star</span>
                        <span className="material-symbols-outlined fill text-star">star</span>
                        <span className="material-symbols-outlined fill text-star">star</span>
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">只有 Cardle 最貼近我真正的思考方式</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
                        從 Notion 到 Obsidian，我試過各種筆記工具，但大多仍是「頁面內的線性紀錄」。Cardle
                        讓我把想法像卡片一樣自由擺放、拖曳、串連，腦中的路徑就能在畫面上被看見。當我需要專注時，它是乾淨的白板；當我需要連結時，它是可以任意拉線的地圖。這不只是記錄，而是我每天工作流程的延伸，回顧時只要一眼就能找到關鍵。
                      </p>
                    </div>
                    {/* 評論時間 */}
                    <time dateTime="2021-11-23" className="font-Manrope text-gray-500 fs-xs lh-1">
                      23 Nov 2021
                    </time>
                  </div>
                  {/* user_02 */}
                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow mb-6">
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">我從來沒想過，整理知識可以這麼直覺！</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow mb-6">
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">卡片盒設計太棒了！</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow mb-6">
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">Cardle 讓我第一次『看見』思考的脈絡</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow">
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">『 閱讀追蹤 』功能超實用</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
                ...
                <SwiperSlide className="swiper-slide">
                  ...
                  <div className="bg-gray-0 p-4 border border-primary-100 rounded-4 shadow">
                    ...
                    {/* 評論內容 */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 lh-base fs-m fs-md-l mb-2">卡片筆記讓資訊變得更輕盈</h3>
                      <p className="text-gray-600 fs-s fs-md-m">
            ...
            <div className="container">
              ...
              <div className="mb-10 mb-md-20">
                ...
                <div className="d-flex justify-content-center gap-2 gap-md-6">
                  <span className="badge badge-gray-light fs-md-2xl lh-base lh-md-sm py-md-2 px-md-4"># 簡單起步</span>
                  <span className="badge badge-gray-light fs-md-2xl lh-base lh-md-sm py-md-2 px-md-4"># 彈性升級</span>
