...
export default function Plan() {
  const historyOrders = useSelector((state) => state.subscription.historyOrders);
        ...
        <section>
          <div className="card border-0 border-md border-gray-200 rounded-4">
            <div className="card-body p-0 p-md-6">
              <h2 className="fs-l fs-md-xl text-gray-1000 lh-sm mb-6">付款資訊</h2>
              ...
              <div className="d-flex flex-column flex-md-row align-items-md-center gap-3 pb-6 border-bottom mb-6">
                <div className={`text-gray-600 mb-3 d-flex flex-column flex-md-row ${paymentMethod && 'gap-3'}`}>
                  <div>付款方式：</div>
                  <div>
                    {paymentMethod && (
                      <>
              ...
              >
                <div className="text-gray-600 d-flex align-items-center gap-2">
                  ...
                  <span className="icon-wrapper">
                    <span className="material-symbols-outlined icon-collapsed">keyboard_arrow_down</span>
                    <span className="material-symbols-outlined icon-expanded">keyboard_arrow_up</span>
                  </span>
                </div>
              </button>
                        ...
                        <table className="table align-middle mb-0 payment-record">
                          ...
                          <tbody>
                            {historyOrders.map((order) => (
                              <tr key={order.id}>
                                <td>{formatDate(order.subscribeDate, 'slash')}</td>
