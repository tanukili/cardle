                ...
                <div className="col-md-5">
                  <div className="d-flex flex-column align-items-center mb-10 mb-md-0">
                    <div className="profile-image mb-4">
                      <img src={userInfo.avatarUrl || DEFAULT_AVATAR_URL} alt="profile-image" />
                    </div>
                    ...
                    <div className="flex-grow-0">
                      ...
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <button type="button" className="btn btn-primary-100 p-1 rounded-circle">
                          <span className="material-symbols-outlined align-bottom">edit</span>
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-md-7">
                  <div className="mb-6">
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <span className="fs-xs badge badge-secondary">已驗證</span>
                    </div>
                    <p>{userInfo.email}</p>
                  </div>
                  <div className="mb-6">
                  ...
                  <div className="mb-6">
                    <div className="d-flex align-items-center gap-2 mb-2">
                      ...
                      <a href="#" className="fs-xs link-primary text-decoration-underline link-offset-1">
                        立即驗證
                      </a>
                    </div>
                    <div className="d-flex align-items-center gap-3">
