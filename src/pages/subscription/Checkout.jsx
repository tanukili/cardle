  ...
  const executeOrder = async (cardData, modeLabel) => {
    ...
    try {
      ...
      if (refundInfo?.amount > 0) {
        showSwalToast({
          title: `訂閱成功！舊方案剩餘的 $${refundInfo.amount} 元將退回您的帳戶。`,
        });
      } else {
        showSwalToast({
          title: isNewPlanFree ? '免費方案已成功開通！' : '付費方案訂閱成功！',
        });
      }
      navigate(`/subscription/success/${orderId}`, {
        state: {
        ...
        <div className="col-md-8 mb-6">
          <div className="card shadow-sm border-0 custom-plan-card p-3">
            <div className="card-body p-6 p-md-8">
              <h2 className="card-title fw-bold pb-4 mb-6 border-bottom">
                ...
                <div className="accordion accordion-flush" id="planDetails">
                  <div className="accordion-item">
                    <h2 className="accordion-header d-flex flex-column">
                      <button
                        className="accordion-button px-0 py-0 fw-bold mb-4"
                        type="button"
                ...
                <div className="mb-4">
                  ...
                  <ul className="nav nav-pills border rounded overflow-hidden d-flex" id="paymentTab" role="tablist">
                    <li className="nav-item flex-fill text-center w-50" role="presentation">
                      <button
                        className="nav-link active w-100 rounded-0 py-2 btn-payment"
                        id="credit-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#pane-credit"
                        type="button"
                        role="tab"
                      >
                        信用卡
                    ...
                    <li className="nav-item flex-fill text-center w-50" role="presentation">
                      <button
                        className="nav-link w-100 rounded-0 py-2 btn-payment"
                        id="newebpay-tab"
                        data-bs-toggle="pill"
                        data-bs-target="#pane-newebpay"
                        type="button"
                        role="tab"
                      >
                        藍新 NewebPay
                ...
                <div className="tab-content" id="pills-tabContent">
                  <div className="tab-pane show active" id="pane-credit" role="tabpanel">
                    <form onSubmit={handleSubmit(handleManualPay)}>
                      <div className="mb-3">
                        <label htmlFor="cardUser" className="form-label fw-bold">
                          持卡人姓名
                        </label>
                        <input
                          {...register('cardHolder')}
                        ...
                        />
                        {errors.cardHolder && <p className="invalid-feedback">{errors.cardHolder.message}</p>}
                      </div>
                      <div className="mb-3">
                        <label htmlFor="cardNum" className="form-label fw-bold">
                          信用卡號
                        </label>
                        ...
                        {errors.cardNumber && <p className="invalid-feedback">{errors.cardNumber?.message}</p>}
                      </div>
                      <div className="row g-2 mb-3">
                        <div className="col-6">
                          <label htmlFor="EXDate" className="form-label fw-bold">
                            Exp Date
                          </label>
                          <input
                            {...register('expDate')}
                            ...
                            placeholder="MM/YY"
                          />
                          {errors.expDate && <p className="invalid-feedback">{errors.expDate?.message}</p>}
                        </div>
                        <div className="col-6">
                          ...
                          <input
                            ...
                            placeholder="e.g 123"
                          />
                          {errors.expDate && <p className="invalid-feedback">{errors.cvv?.message}</p>}
                        </div>
                      </div>
                      <div className="mb-4">
                      ...
                      <div className="d-grid">
                        ...
                        >
                          {isSubmitting || isProcessing ? '處理中...' : 'PAY NOW'}
                        </button>
                      </div>
                    </form>
                  </div>
                  <div className="tab-pane" id="pane-newebpay" role="tabpanel">
                    ...
                    <div>
                      ...
                      {step === 2 && (
                        <div>
                          <h3>模擬藍新信用卡支付</h3>
                          <button type="button" className="btn btn-primary" onClick={handleNewebPaySim}>
                            確認刷卡 (Axios 觸發)
                          </button>
                        </div>
                      )}
