...
export default function Detail() {
  ...
  return(
    <div>
      ...
      <Swiper className="plan-swiper" initialSlide={2} centeredSlides={true} slidesPerView={"auto"} spaceBetween={40} centerInsufficientSlides={true} centeredSlidesBounds={true} resistanceRatio={0} watchOverflow={true} breakpoints={{320: {
             spaceBetween: 24,
          },
          992: {
            spaceBetween: 40
