    ...
    <div>
      <section className="bg-gray-98 py-md-25 py-20">
        <div className="container text-center">
          ...
          <div className="mb-6">
            <span className="fs-md-2xl fs-s badge text-tag-secondary bg-tag-secondary-bg py-md-2 px-md-4 py-1 px-2 me-6 rounded-1">
              # 簡單起步
            </span>
            <span className="fs-md-2xl fs-s badge text-tag-orange bg-tag-orange-bg py-md-2 px-md-4 py-1 px-2 me-6 rounded-1">
              # 彈性升級
            </span>
            <span className="fs-md-2xl fs-s badge text-tag-success bg-tag-success-bg py-md-2 px-md-4 py-1 px-2 rounded-1">
              # 讓筆記陪你成長
            </span>
          </div>
          <p className="fs-md-2xl fs-l fw-bold mb-md-20 mb-10 d-flex flex-column flex-md-row justify-content-center align-items-center text-center">
            無論你是學生還是專業人士，
          ...
          >
              ...
              <div className="bg-gray-0 p-6 border border-gray-100 rounded-4 d-flex flex-column h-100">
                ...
                {isLoggedIn ? (
                  <>
                    <Link
                      href="#"
                      className="btn btn-outline-gray-400 py-md-4 mt-auto w-100 fs-md-5 fs-6"
                      to={`/subscription/checkout/plan_free`}
                    >
                      選擇方案
                    </Link>
                  </>
            ...
            <SwiperSlide className="col-md-4 col-12 h-auto">
              <div className="bg-gray-0 p-6 border border-2 border-secondary rounded-4 shadow d-flex flex-column h-100">
                ...
                <Link
                  href="#"
                  className="btn btn-secondary py-md-4 mt-auto w-100 fs-md-5 fs-6"
                  to={`/subscription/checkout/plan_pro_month`}
                >
                  升級方案（推薦）
                </Link>
              </div>
            ...
            <SwiperSlide className="col-md-4 col-12 h-auto">
              <div className="bg-gray-0 p-6 border border-gray-100 rounded-4 d-flex flex-column h-100">
                ...
                <Link
                  href="#"
                  className="btn btn-outline-gray-400 py-md-4 mt-auto w-100 fs-md-5 fs-6"
                  to={`/subscription/checkout/plan_pro_year`}
                >
                  升級方案
                </Link>
              </div>
              ...
              <div className="row justify-content-center">
                <div className="col-md-8 col-11  py-md-20 py-10">
                  <div className="accordion" id="faqAccordion">
                    <FAQItem
                      question="我想進一步了解方案，可以說明方案的詳細內容嗎？"
                      isOpen={activeKey === 'item1'}
