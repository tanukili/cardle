    ...
    <div className="d-flex flex-column min-vh-100">
      <main className="flex-grow-1 d-flex align-items-center">
        <div className="container text-center py-16">
          ...
          <span className="material-symbols-outlined display-1">check_circle</span>
          <div className="d-flex flex-column align-items-center">
            <>
              {!isFree ? (
                <>
                  <p className="mb-4">
                    感謝您訂閱 {order.planId} 方案，我們已成功處理您的付款。
                    <br />
                    確認信件將寄送至 {Unfo?.email}！
                  </p>
                  <button type="button" className="btn btn-dark py-3 fw-bold" onClick={() => navigate('/user')}>
                    前往儀錶板
                  </button>
                </>
              ) : (
                <>
                  <h2 className="mb-4">免費方案已啟用</h2>
